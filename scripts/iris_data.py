"""
Iris dataset — hard-coded to avoid sklearn/datasets dependency.
150 samples, 4 features (sepal_len, sepal_wid, petal_len, petal_wid), 3 classes.
"""
import numpy as np
...
_raw = [
    ...
    # class 2 — Iris virginica (50 samples)
...
X_raw = np.array([r[:4] for r in _raw], dtype=np.float64)
y_raw = np.array([0]*50 + [1]*50 + [2]*50, dtype=np.int64)
